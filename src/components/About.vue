  ...
  <section id="about" class="bg-bg py-12 px-4">
    ...
    >
      ...
      <div class="bg-primary/20 p-6 rounded-2xl space-y-10 md:space-y-4 h-full">
        ...
        >
          <a
            >Современные методики, инновационные технологии и искреннее внимание
        ...
        >
          <a
            >Мои принципы работы - это доверие и открытость. Опираясь на
            доверие, можно решать самые ответственные и сложные задачи.</a
          >
        </p>
...
2024–н. в. — врач-оториноларинголог, «Атмосфера»`,
  },
  {
    ...
    Тугоухость, отиты,  серные пробки, риниты, синуситы, носовые кровотечения.`,
  },
];
